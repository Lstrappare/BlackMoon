    ...
    <div className="">
      ...
      <div className="grid grid-cols-3 gap-6 mt-6 container mx-auto">
        {sucursales.map((sucursal) => (
          <div key={sucursal.sucursal_id} className={` rounded-xl shadow-2xl ${aperturaOCierreAutomatico(sucursal) ? 'bg-green-200' : 'bg-red-300'}`}>
            <h2 className="text-lg font-bold mb-2 bg-purple-400 text-gray-100 p-2 text-center">{sucursal.nombreSucursal}</h2>
            <div className="p-4"> 
